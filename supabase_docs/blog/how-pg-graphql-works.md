...
The grammar tells the tokenizer that if the next character is a
...
💡 If you are familiar with compiler theory, you can think of the validation
...
💡 There’s also a [`MutationEntrypoint`
